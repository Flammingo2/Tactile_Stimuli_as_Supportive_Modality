...
wordlist_data_accuracy_log = array2table(log(wordlist_means_data.accuracy_mean), ...
...
for pointer = 1:14  
    ...
    wordlist_data_accuracy = [wordlist_data_accuracy;[vp.log_accuracy_mean']];
...
for column = 1:8
    ...
    histogram(table2array(wordlist_data_accuracy(:,column)))
