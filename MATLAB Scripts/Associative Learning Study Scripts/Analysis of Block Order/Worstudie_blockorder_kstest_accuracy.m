...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Check Block Order Factor
% Calculate means of accuracy with block order factor
...
% Create table with means and factor variables
grps1 = str2double(grps(:,1:3))
grps2 = string(grps(:,4:5))
means_data_block_order = table(grps1(:,1), grps1(:,2), grps(:,3), grps2(:,1), grps2(:,2), means(:,1), 'VariableNames', {'VP_Nr' 'day' 'number_recall' 'tactile' 'block_order' 'accuracy_mean'} );
data = means_data_block_order;

% Test grouping of block order 
% Just over block order and modality
group_classic_tactile = means_data_block_order(strcmpi(means_data_block_order.tactile, "true") & strcmpi(means_data_block_order.block_order, "classic"),:);
group_classic_visual = means_data_block_order(strcmpi(means_data_block_order.tactile, "false") & strcmpi(means_data_block_order.block_order, "classic"),:);
    
h = kstest2(group_classic_tactile.accuracy_mean,group_classic_visual.accuracy_mean);
grouping_test_block_modality = h

% Test grouping over block order 
% and all factors
types = ["classic", "tactile"];
for counter = 1:2
    type = types(counter);
    
    % day = 1 
        % number_recall =1
    type_group_tactile_1_recall_1 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "true") & strcmpi(means_data_block_order.number_recall,'1') & means_data_block_order.day == 1,:);
    type_group_visual_1_recall_1 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "false") & strcmpi(means_data_block_order.number_recall,'1') & means_data_block_order.day == 1,:);
    
    h = kstest2(type_group_tactile_1_recall_1.accuracy_mean,type_group_visual_1_recall_1.accuracy_mean);
    type_grouping_test_day_1_1.(strcat("type_",type)) = h;
    
        % number recall = 2
    type_group_tactile_1_recall_2 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "true") & strcmpi(means_data_block_order.number_recall,'2') & means_data_block_order.day == 1,:);
    type_group_visual_1_recall_2 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "false") & strcmpi(means_data_block_order.number_recall,'2') & means_data_block_order.day == 1,:);

    h = kstest2(type_group_tactile_1_recall_2.accuracy_mean,type_group_visual_1_recall_2.accuracy_mean);
    type_grouping_test_day_1_2.(strcat("type_",type)) = h;
    
    % day = 2
        % number recall = 1
    type_group_tactile_2_recall_1 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "true") & strcmpi(means_data_block_order.number_recall,'1') & means_data_block_order.day == 2,:);
    type_group_visual_2_recall_1 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "false") & strcmpi(means_data_block_order.number_recall,'1') & means_data_block_order.day == 2,:);
    
    h = kstest2(type_group_tactile_2_recall_1.accuracy_mean,type_group_visual_2_recall_1.accuracy_mean);
    type_grouping_test_day_2_1.(strcat("type_",type)) = h;
    
        % number recall = 2
    type_group_tactile_2_recall_2 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "true") & strcmpi(means_data_block_order.number_recall,'2') & means_data_block_order.day == 2,:);
    type_group_visual_2_recall_2 = means_data_block_order(strcmpi(means_data_block_order.block_order, type) & strcmpi(means_data_block_order.tactile, "false") & strcmpi(means_data_block_order.number_recall,'2') & means_data_block_order.day == 2,:);
    
    h = kstest2(type_group_tactile_2_recall_2.accuracy_mean,type_group_visual_2_recall_2.accuracy_mean);
    type_grouping_test_day_2_2.(strcat("type_",type)) = h;
end 

grouping_test_block_modality
type_grouping_test_day_1_1
type_grouping_test_day_1_1
type_grouping_test_day_2_1
type_grouping_test_day_2_2

%% Save variables/data to .mat file to load into python
save 'Wortstudie_blockorder_accuracy_data_to_plot.mat' data_plot_accuracy data means_data_log answer_frequencies missing_data_frequency ranova_accuracy;
save 'Wortstudie_blockorder_RT_data_to_plot.mat' data_plot_RT data data_RT ranova_RT;