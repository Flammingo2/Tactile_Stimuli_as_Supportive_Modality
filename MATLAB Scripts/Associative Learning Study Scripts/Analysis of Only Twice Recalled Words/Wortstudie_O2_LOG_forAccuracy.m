...
%% Discard just Once Recalled Words
% Find rows with only words of wordlist 1 and 3 as these will be recalled
% twice
data_2recallwords = data(data.word_list == 1 | data.word_list == 3, :);
data = data_2recallwords;

% FINAL For plotting accuracy
writetable(data, 'wortstudie_o2_to_plot_accuracy.csv');
...
save 'Wortstudie_accuracy_data_to_plot.mat' data_plot_accuracy data means_data_log answer_frequencies missing_data_frequency ranova_accuracy grouping_test grouping_test_recall_1 grouping_test_recall_2;
save 'Wortstudie_RT_data_to_plot.mat' data_plot_RT data ranova_RT;