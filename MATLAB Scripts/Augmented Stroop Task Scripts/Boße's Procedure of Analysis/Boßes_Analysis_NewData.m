...
data.VariableTypes = {'double','double', 'double', 'char', 'char', 'char',...
    ...
    for day = 1:2
        ...
        for modality = 0:1
            ...
            for counter = 1:2
                ...
                % Find outlier indices using 
                % self-written function 'outlier_detection'
                [indices_outlier, number_outlier] = outlier_detection(treatment);
                % Delete outliers from treatment
                treatment(indices_outlier, :) = [];
                % Delete all rows of this condition from data to be 
                % replaced by outlier free treatment data
                toDelete = data.accuracy == 1 & ...
                            data.VP_Nr == subjects & ...
                            data.day == day & ...
                            data.vibration == modality & ...
...
writetable(data, 'replication_FAnalysis_ourdata_to_plot_accuracy.csv');
...
writetable(data, 'replication_FAnalysis_ourdata_to_plot_RT.csv');
data_plot_RT = data;
...
save 'replication_FAnalysis_ourdata_accuracy_data_to_plot.mat' data_plot_accuracy means_data answer_frequencies missing_data_frequency outlier_frequency_all ranova_accuracy ;
save 'replication_FAnalysis_ourdata_RT_data_to_plot.mat' data_plot_RT ranova_RT;