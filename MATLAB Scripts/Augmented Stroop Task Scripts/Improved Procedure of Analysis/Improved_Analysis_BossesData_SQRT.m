...
%% DATA IMPORT
% Import all data in from file named 'Francas_Daten_geordnet.xlsx'
...
writetable(data, 'replication_MyAnalysis_Fdata_data_to_plot_accuracy.csv');
...
writetable(data, 'replication_MyAnalysis_Fdata_data_to_plot_RT.csv');
data_plot_RT = data;
        ...
        for pointer2 = 1:2
            ...
            for modality = 0:1
                ...
                while height(condition) < 154
                    condition = [condition; array2table(NaN(1,14),...
...
% Merge vp tables horizontally
data_RT = [vp_RT.subject_17; vp_RT.subject_18; vp_RT.subject_19;...
           vp_RT.subject_20; vp_RT.subject_21; vp_RT.subject_22;...
           vp_RT.subject_23; vp_RT.subject_24; vp_RT.subject_25;...
           vp_RT.subject_26];
...
save 'replication_RANOVA_MyAnalysis_Franca_accuracy_data_to_plot.mat' data_plot_accuracy means_data answer_frequencies missing_data_frequency ranova_accuracy grouping_test grouping_test_congruent grouping_test_incongruent;
save 'replication_RANOVA_MyAnalysis_Franca_RT_data_to_plot.mat' data_plot_RT ranova_RT;